			...
			<div id="content" class="site-content"><div class="container"><div class="inner-wrapper">
				<div id="primary" class="content-area">
					<main id="main" class="site-main" role="main">
                        <a href="{{ route('ls.edit', ['id' => $LktsLs->id_lkts_ls]) }}">Назад</a><br /><br />
						<article id="post-33" class="post-33 page type-page status-publish has-post-thumbnail hentry">
							<header class="entry-header"><h2 class="entry-title">Редактирование Прибора учета</h2></header>
								<div class="entry-content">
                                <form name="feedback" method="post" action="{{ route('ls.update_pu', ['id' => $LktsLs->id]) }}" class="form-horizontal" >
                                    @csrf
                                    ...
                                    <div class="text-right">
                                            <a href="#" class="pull-right btn btn-outline-dark btn-sm">
                                              Добавить документ
                                            </a>
                                        </div><br />
