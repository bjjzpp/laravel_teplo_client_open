			...
			<div id="content" class="site-content"><div class="container"><div class="inner-wrapper">
				<div id="primary" class="content-area">
					<main id="main" class="site-main" role="main">
                        <a href="{{ route('ls.edit', ['id' => $pid]) }}">Назад</a><br /><br />
						<article id="post-33" class="post-33 page type-page status-publish has-post-thumbnail hentry">
							<header class="entry-header"><h2 class="entry-title">Показания прибора учета</h2></header>
                                ...
                                <form name="feedback" method="post" action="{{ route('ls.store_puots') }}" class="form-horizontal" >
                                    @csrf
