						...
						<article class="page type-page status-publish has-post-thumbnail hentry">
							<header class="entry-header"><h2 class="entry-title">Добавление</h2></header>
								<div class="entry-content">
                                    <form name="feedback" method="post" action="{{ route('admin.home.rco.store') }}" class="form-horizontal" >
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <textarea id="full_text" class=" form-control{{ $errors->has('full_text') ? ' is-invalid' : '' }}" name="full_text" rows="7" cols="220" class="form-control"></textarea>
                                    ...
                                    <div class="form-group row">
                                            <input type="checkbox" name="rso" value="yes">
                                        <label class="col-md-4 col-form-label text-md-right" for="rso">
                                            {{ __('Для прямых договоров с РСО') }}
                                        </label>
                                    </div>
                                    <div class="form-group row">
                                            <input type="checkbox" name="map" value="yes">
                                        <label class="col-md-4 col-form-label text-md-right" for="maps">
                                            {{ __('Использовать Яндекс.Карты') }}
                                        </label>
                                    </div>
