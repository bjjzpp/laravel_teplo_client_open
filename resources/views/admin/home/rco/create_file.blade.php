                    ...
                    <a href="{{ route('admin.home.rco.edit', ['id' => $Rco->id ]) }}">Назад</a><br /><br />
                        ...
                        <header class="entry-header"><h2 class="entry-title"></h2></header>
								<div class="entry-content">
                                    <form name="feedback" method="post" action="{{ route('admin.home.rco.fiels.store') }}" class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input id="nfiles" type="text" class="form-control{{ $errors->has('nfiles') ? ' is-invalid' : '' }}" name="nfiles" value="" size="200px">
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input id="pfiles" type="file" class="form-control-file {{ $errors->has('pfiles') ? ' is-invalid' : '' }}" name="pfiles" value="" size="200px">
