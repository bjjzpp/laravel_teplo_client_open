				...
				<div id="primary" class="content-area">
					<main id="main" class="site-main" role="main">
						...
						<article class="page type-page status-publish has-post-thumbnail hentry">
							<header class="entry-header"><h2 class="entry-title">Загрузка квитанций с расшифровкой в формате (xml)</h2></header>
							    <div class="entry-content">
                                <form id="upload" method="post" action="{{ route('admin.imports.lsu_ompts.uploadchangexml') }}" class="form-horizontal" enctype="multipart/form-data">
                                        @csrf
